...
Dynamic Memory Allocation can be defined as a procedure in which the size of a data structure (like [[C/structures/arrays/arrays]]) is changed during the runtime.
