...
Dynamic Memory Allocation can be defined as a procedure in which the size of a data structure (like [[C/data structures/arrays/arrays]]) is changed during the runtime.
